...
function Banner() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 mt-[-160px] flex flex-col items-center px-4 text-center text-white">
        <div>
          <svg
        ...
        <h1 className="text-2xl font-bold drop-shadow-lg sm:text-4xl md:text-5xl lg:text-6xl">
          Chung tay trao yêu thương và Thắp sáng hy vọng
        </h1>
        <p className="mt-4 text-lg font-semibold sm:text-2xl md:text-3xl lg:text-4xl">
        ...
        <button className="mt-6 rounded-lg bg-yellow-500 px-6 py-3 text-lg font-bold shadow-lg transition hover:bg-yellow-600">
          Tham gia ngay
        </button>
      </div>
      ...
      <div className="absolute bottom-[6px] left-1/2 z-20 flex h-40 w-[90%] max-w-4xl -translate-x-1/2 transform items-center justify-center rounded-lg bg-[#fdf1e3] shadow-lg">
        <div className="flex gap-6 text-center">
          ...
          <div className="flex flex-col items-center">
            <HelpingHand className="h-10 w-10 text-green-500" />
            <p className="text-sm font-semibold text-gray-700">
