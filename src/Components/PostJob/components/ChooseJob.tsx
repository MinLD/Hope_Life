    ...
    <>
      {isOpen && (
        <div className="relative z-999">
          ...
          <div className="fixed top-1/2 left-1/2 flex h-auto w-auto -translate-x-1/2 -translate-y-1/2 transform flex-col gap-10 rounded-3xl bg-[#fff] p-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative z-2 max-h-[400px]">
                <div className={`flex h-auto w-full justify-between`}>
                  <div className="flex w-1/2 flex-col items-center gap-4">
                    <img
                      ...
                      alt=""
                    />
                    <div className="w-[80%]" onClick={() => setIsOpen(false)}>
                      {" "}
                      <MyButton
